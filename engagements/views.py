...
from .api_tw import get_twitter_api
...
class DetailView(View, TemplateResponseMixin):
    ...
    def get_data(self, links, social_name):
        ...
        return {
            'headers': ['ids'],
            'rows': {'ids': ' '.join(map(str, getattr(self, 'get_%s' % social_name)(links)))},
         }
    ...
    # @staticmethod
    def get_vk(self, links):
        from .api_vk import api_call, api_recursive_call
        ...
        for link in links:
            ...
            if matches:
                ...
                ids.update(likes_user_ids, shares_user_ids, comments_user_ids)
